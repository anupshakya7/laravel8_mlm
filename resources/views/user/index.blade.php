  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url({{URL::asset('front_assets/assets/img/superhero/oval.png')}});opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
